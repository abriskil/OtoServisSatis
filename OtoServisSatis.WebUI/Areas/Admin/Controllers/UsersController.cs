...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        private readonly IService<Rol> _serviceRol; //create yaparken kullanıcı rolünü ekleyebilmek için
        ...
        public async Task<ActionResult> CreateAsync() //Dropdown olarak rolleri getiriyor
        {
        ...
        public async Task<ActionResult> CreateAsync(Kullanici kullanici)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("","Hata Oluştu!"); //key kısmı bir sayfadaki property'e gönderilecekse kullanılıyor. Hata genele göderildiği için key kısmı boş.
                }
            }
            ViewBag.RolId = new SelectList(await _serviceRol.GetAllAsync(),"Id","Adi");
